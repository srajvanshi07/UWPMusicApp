...
namespace UWPMusicApp
{
        ...
        global::Windows.UI.Xaml.Markup.IComponentConnector2
    {
            ...
            IMainPage_Bindings
        {
            ...
            {
                 global::UWPMusicApp.Model.MenuItem data = args.NewValue as global::UWPMusicApp.Model.MenuItem;
                 if (args.NewValue != null && data == null)
                 {
                    throw new global::System.ArgumentException("Incorrect type passed into template. Based on the x:DataType global::UWPMusicApp.Model.MenuItem was expected.");
                 }
            ...
            public int ProcessBindings(global::Windows.UI.Xaml.Controls.ContainerContentChangingEventArgs args)
            {
                ...
                switch(args.Phase)
                {
                    case 0:
                        nextPhase = -1;
                        this.SetDataRoot(args.Item as global::UWPMusicApp.Model.MenuItem);
                ...
                this.Update_((global::UWPMusicApp.Model.MenuItem) args.Item, 1 << (int)args.Phase);
                return nextPhase;
            }
            ...
            public void SetDataRoot(global::UWPMusicApp.Model.MenuItem newDataRoot)
            {
            ...
            private void Update_Category(global::UWPMusicApp.Model.Music.MusicCategory obj, int phase)
            {
                if((phase & ((1 << 0) | NOT_PHASED )) != 0)
                {
            ...
            IMainPage_Bindings
        {
            ...
            public void DataContextChangedHandler(global::Windows.UI.Xaml.FrameworkElement sender, global::Windows.UI.Xaml.DataContextChangedEventArgs args)
            {
                 global::UWPMusicApp.Model.Music data = args.NewValue as global::UWPMusicApp.Model.Music;
                 if (args.NewValue != null && data == null)
                 {
                    throw new global::System.ArgumentException("Incorrect type passed into template. Based on the x:DataType global::UWPMusicApp.Model.Music was expected.");
                 }
                 this.SetDataRoot(data);
                 this.Update();
            }
            ...
            public int ProcessBindings(global::Windows.UI.Xaml.Controls.ContainerContentChangingEventArgs args)
            {
                ...
                switch(args.Phase)
                {
                    case 0:
                        nextPhase = -1;
                        this.SetDataRoot(args.Item as global::UWPMusicApp.Model.Music);
                        if (!removedDataContextHandler)
                        {
                            removedDataContextHandler = true;
                ...
                this.Update_((global::UWPMusicApp.Model.Music) args.Item, 1 << (int)args.Phase);
                return nextPhase;
            }
            ...
            public void SetDataRoot(global::UWPMusicApp.Model.Music newDataRoot)
            {
                this.dataRoot = newDataRoot;
            }
            ...
            IMainPage_Bindings
        {
            ...
            public void SetDataRoot(global::UWPMusicApp.MainPage newDataRoot)
            {
                this.dataRoot = newDataRoot;
            }
            ...
            private void Update_musics(global::System.Collections.ObjectModel.ObservableCollection<global::UWPMusicApp.Model.Music> obj, int phase)
            {
                if((phase & ((1 << 0) | NOT_PHASED )) != 0)
                {
            ...
            case 4:
                {
                    ...
                    returnValue = bindings;
                    bindings.SetDataRoot((global::UWPMusicApp.Model.MenuItem) element4.DataContext);
            ...
            case 10:
                {
                    ...
                    returnValue = bindings;
                    bindings.SetDataRoot((global::UWPMusicApp.Model.Music) element10.DataContext);
